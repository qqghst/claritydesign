	...
	return (
		<>
			<div className={styles.overlay}>
				{isMobile ? (
					<svg viewBox='2 2 500 300' preserveAspectRatio='none' style={{ width: '100vw', height: '100vh' }}>
			...
			<div className={styles.menuItems} ref={menuItemsRef}>
				<div className={styles.menuContainer}>
					{links.map((item, index) => (
						<h1 key={item.id} className={`h1 ${styles.text}`}>
							<Link href={item.href} className={styles.block} onClick={() => toggleMenuRef.current()}>
