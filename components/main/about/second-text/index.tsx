		...
		<div className={`${styles.secondText}`}>
			<div className={styles.secondText__container}>
				<div ref={textRef} className={`h3 ${styles.textContainer}`}>
					<span className={`${styles.numbers}`}>123456789</span>We create a <span>stylish websites</span> with{' '}
					<br className='hidden md:block' />
					<span>beautiful visuals,</span>{' '}
					<span className={`${styles.hero} ${styles.layers} ${styles.glitch}`} data-text='animations'>
						<span>animations</span>
					</span>
					<span className='italic'>, fonts</span> and so on <br className='hidden md:block' />
